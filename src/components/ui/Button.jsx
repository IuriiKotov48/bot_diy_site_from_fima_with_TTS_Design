...
const Button = ({ 
  ...
  const variants = {
    primary: 'bg-[linear-gradient(135deg,#20212b_0%,_#16171f_100%)] text-global-4 hover:opacity-90 focus:ring-gray-500',
    secondary: 'bg-gray-200 text-gray-800 hover:bg-gray-300 disabled:bg-gray-100 focus:ring-gray-400',
    outline: 'border border-gray-300 text-gray-700 hover:bg-gray-50 disabled:border-gray-200 disabled:text-gray-400 focus:ring-gray-400',
  };
